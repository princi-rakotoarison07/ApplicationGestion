  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        <h1 style={styles.title}>Gestion des présences/absences</h1>
        <div style={styles.subtitle}>Employé #{id} • Période: {periode || '—'}</div>
      </div>
      <div style={styles.card}>
        Cette page sera dédiée à la gestion des présences et des absences pour la période sélectionnée.
        Vous pourrez y ajouter, modifier ou supprimer des entrées de présence.
      </div>
